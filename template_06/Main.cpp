...
// UWAGA: Implementacji wszystkich metod poza klasą.
...
int main() {
 ...
 std::cout << b.at<1,1>() << " " << a.at<0,2>()  << std::endl<< std::endl;
  ...
  a.add(c);         // a to sie kompiluje bo wymiary sa takie same, moimo ze typy sa rozne
  std::cout << a;
